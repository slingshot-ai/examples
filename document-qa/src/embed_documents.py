...
"""
Script used to generate embeddings for the mounted documents file - in our base example these are essays by Paul Graham.
...
async def get_embedding(text: str, *, sdk: SlingshotSDK) -> np.ndarray:
    try:
        ...
        print(f"Failed to get embedding, filling it with zeros.")
        print(e)
...
async def embed_documents(
    ...
    async def return_embedding(embedding: np.ndarray) -> np.ndarray:
        return embedding
